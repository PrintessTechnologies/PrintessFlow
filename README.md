...
**The slicer for Printess Technologies 3D gel & bio printers (Printessa Series).**
A customized, pre-configured build of [UltiMaker Cura](https://github.com/Ultimaker/Cura).

### [⬇ Download the latest Windows installer](https://github.com/PrintessTechnologies/PrintessFlow/releases/latest/download/PrintessFlow-Setup.exe)
...
Download the latest installer above and run it again. It replaces the previous version in place.

## License & attribution

PrintessFlow is based on **UltiMaker Cura** (LGPLv3) and **CuraEngine** (AGPLv3). The full license texts are bundled with the installation. The sections below are from the upstream UltiMaker Cura project.
